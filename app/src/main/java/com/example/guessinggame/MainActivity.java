...
import static com.example.guessinggame.R.menu.menu_main;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void newGame() {
        ...
        lblRange.setText("Enter a random number between 1 and " + range +".");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_about:
                ...
                aboutDialog.setMessage("(c)2020 Scott Richardson.");
